  ...
  let template = `<div class="hbe hbe-container" id="hexo-blog-encrypt" data-wpm="{{hbeWrongPassMessage}}" data-whm="{{hbeWrongHashMessage}}">
      ...
      <div class="hbe hbe-content">
        <div class="hbe hbe-input hbe-input-${theme}">
          ...
          <label class="hbe hbe-input-label hbe-input-label-${theme}" for="hbePass">
            <span class="hbe hbe-input-label-content hbe-input-label-content-${theme}" data-content="{{hbeMessage}}">{{hbeMessage}}</span>
          </label>
        </div>
